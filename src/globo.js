...
function init() {
	...
	_.times(20, function() {
		var globo = new pitarupaterson.Globo();
...
pitarupaterson.Globo.sectionSpriteSheets = [
...
p.initialize = function() {
	...
	var globo = this,
		sections = [
			new c.BitmapAnimation( pitarupaterson.Globo.sectionSpriteSheets[0] ),
			new c.BitmapAnimation( pitarupaterson.Globo.sectionSpriteSheets[1] ),
			new c.BitmapAnimation( pitarupaterson.Globo.sectionSpriteSheets[2] ),
			new c.BitmapAnimation( pitarupaterson.Globo.sectionSpriteSheets[3] )
		],
